...
for ARGI; do
	...
	echo "                                                 "
	echo "Options (custom):                                "
	echo "  --modem_id=<1>       Acoustic modem ID         "
	exit 0;
    ...
    elif [ "${ARGI:0:11}" = "--modem_id=" ]; then
        MODEM_ID="${ARGI#--modem_id=*}"
    else
...
#------------------------------------------------------------
#  Part 4: If field vehicle, derive identity from the IP address
#          (greece BlueBoat fleet: asha/bama/chip/dale/ewan/flex)
#------------------------------------------------------------
if [ "${XMODE}" = "BBOAT" ]; then
...
#------------------------------------------------------------
#  Part 4c: The single common encircle circle (same for all vehicles).
#------------------------------------------------------------
CIRCLE_X=-86
CIRCLE_Y=-33
CIRCLE_RAD=20
